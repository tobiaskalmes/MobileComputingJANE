...
import de.uni_trier.jane.platform.basetypes.PlatformDeviceID;
import de.uni_trier.jane.platform.serviceManager.RealClock;
import de.uni_trier.jane.platform.serviceManager.TimerSystem;
 ...
 */
public abstract class ExecutionPlatform2 implements ServiceFactory, DeviceServiceFactory {
    ...
    public void run() {
        ...
        deviceID = new PlatformDeviceID(platformParameters.getNetworkAddress());
