 ...
 * 
 * $Id: NeighborDiscoveryDataEventDelete.java,v 1.1 2007/06/25 07:24:16 srothkugel Exp $
 *  
...
/**
 * A <code>ServiceEvent</code> propagated by a <code>NeighborDiscoveryService</code> when an earlier 
 * received <code>Data</code>  of a neighbor device has been removed. 
 * 
 ...
 */
public class NeighborDiscoveryDataEventDelete extends NeighborDiscoveryDataEvent {


    
    /**
     * SenderConstructor for class <code>NeighborDiscoveryDataEventNew</code>
     * @param data
     * @param sender
     */
    public NeighborDiscoveryDataEventDelete(Data data, Address sender) {
        super(data, sender);
    }
     ...
     */
    public NeighborDiscoveryDataEventDelete(ServiceID eventSenderID,
            Class eventSenderClass, DataID dataID, Address sender) {
        super(eventSenderID, eventSenderClass, dataID, sender);
    }

    /**
     * Constructor for class <code>NeighborDiscoveryDataEventDelete</code>
     * @param dataID                the data ID of the corresponding <code>Data</code>
     * @param sender                the <code>Address</code> of the device propagating the corresponding data
     */
    public NeighborDiscoveryDataEventDelete(DataID dataID, Address sender) {
        super(dataID, sender);
    }
    
    
    public Class getReceiverServiceClass() {
        return NeighborDiscoveryDataEventDeleteHandler.class;
    }
    
   public void handle(SignalListener listener) {
       ((NeighborDiscoveryDataEventDeleteHandler)listener).handleDeleteData(data,sender);
   }
