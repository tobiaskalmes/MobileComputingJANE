 ...
 * 
 * $Id: NeighborDiscoveryDataEventUpdate.java,v 1.1 2007/06/25 07:24:16 srothkugel Exp $
 *  
...
/**
 * A <code>ServiceEvent</code> propagated by a <code>NeighborDiscoveryService</code> when a received <code>Data</code> 
 * of a neighbor has changed. 
 * 
 ...
 */
public class NeighborDiscoveryDataEventUpdate extends NeighborDiscoveryDataEvent {
     ...
     * @param sender
     */
    public NeighborDiscoveryDataEventUpdate(Data data, Address sender) {
        super(data, sender);
        // TODO Auto-generated constructor stub
    }

    /**
     * TemplateConstructor for class <code>NeighborDiscoveryDataEventUpdate</code>
     ...
     */
    public NeighborDiscoveryDataEventUpdate(ServiceID eventSenderID,
     ...
     * @param sender                the <code>Address</code> of the device propagating the corresponding data
     */
    public NeighborDiscoveryDataEventUpdate(DataID dataID, Address sender) {
        super(dataID, sender);       
    }
    
    public Class getReceiverServiceClass() {
        return NeighborDiscoveryDataEventUpdateHandler.class;
    }
    
   public void handle(SignalListener listener) {
       ((NeighborDiscoveryDataEventUpdateHandler)listener).handleUpdateData(data,sender);
   }
}
