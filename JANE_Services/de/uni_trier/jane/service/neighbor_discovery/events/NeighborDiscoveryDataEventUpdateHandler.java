...
/**
 * Handler for @see de.uni_trier.jane.service.neighbor_discovery.events.NeighborDiscoveryDataEventUpdate.
 */
public interface NeighborDiscoveryDataEventUpdateHandler extends SignalListener {
     ...
     * @param sender
     */
    void handleUpdateData(Data data, Address sender);
