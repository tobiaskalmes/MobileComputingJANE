...
/**
 * Handler for @see de.uni_trier.jane.service.neighbor_discovery.events.NeighborDiscoveryDataEventDelete.
 */
public interface NeighborDiscoveryDataEventDeleteHandler extends SignalListener{
     ...
     * @param sender
     */
    void handleDeleteData(Data data, Address sender);
