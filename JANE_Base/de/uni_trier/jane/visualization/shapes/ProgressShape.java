 ...
 * 
 * $Id: ProgressShape.java,v 1.1 2007/06/25 07:21:36 srothkugel Exp $
 *  
 ...
 */
public class ProgressShape implements Shape {

	private final static String VERSION = "$Id: ProgressShape.java,v 1.1 2007/06/25 07:21:36 srothkugel Exp $";
	...
	public ProgressShape(Address device, double progress) {
	 ...
	 */
	public ProgressShape(Address device, Color borderColor, Color barColor, double length, double width, double progress) {
		this.device = device;
	 ...
	 */
	public ProgressShape(Address device, Color borderColor, Color barColor, double length, double width, double progress, Position relative) {
