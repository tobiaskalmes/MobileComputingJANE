...
public class DefaultClusterTransitionNodeOrder extends PositionCalculator implements ClusterTransitionNodeOrder {
...
//		return nextCluster.getCenter().distance(nextPosition) < nextCluster.getCenter().distance(currentPosition);
		...
		double d1 = calculateProgress(currentCluster.getCenter(), nextCluster.getCenter(), nextPosition);
		double d2 = calculateProgress(currentCluster.getCenter(), nextCluster.getCenter(), currentPosition);
