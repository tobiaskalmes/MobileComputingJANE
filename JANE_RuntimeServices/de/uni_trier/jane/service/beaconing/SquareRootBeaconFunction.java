 ...
 * TODO comment class
 */
public class SquareRootBeaconFunction implements AdaptiveBeaconFunction {
     ...
     * @return 
     */
    public SquareRootBeaconFunction(double minBeaconInterval, double maxBeaconInterval, double incStep) {
        
        this.incStep=incStep;//(maxBeaconInterval-minBeaconInterval)/1000;
    ...
    public double getBeaconBase(int neighbors) {
        return Math.min(minBeaconInterval+incStep*Math.sqrt(neighbors), maxBeaconInterval);
    }
