 ...
 * TODO comment class
 */
public class LinearNeighborReceiveDecider implements ReceiveDecider {
     ...
     */
    public LinearNeighborReceiveDecider(DistributionCreator distributionCreator, double sendingRadiusFactor) {
