 ...
 * TODO comment class
 */
public class StartReceiptEvent extends ServiceEvent {

    private DeviceID deviceID;
    private boolean successs;

    /**
     * Constructor for class <code>StartReceiptEvent</code>
     * @param b
     * @param deviceID
     */
    public StartReceiptEvent(boolean success, DeviceID deviceID) {
