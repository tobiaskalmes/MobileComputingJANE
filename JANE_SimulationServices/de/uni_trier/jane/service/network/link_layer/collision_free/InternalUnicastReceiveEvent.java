 ...
 * 
 * $Id: InternalUnicastReceiveEvent.java,v 1.1 2007/06/25 07:24:49 srothkugel Exp $
 * 
 ...
 */
public class InternalUnicastReceiveEvent extends ServiceTimeout {

	public final static String VERSION = "$Id: InternalUnicastReceiveEvent.java,v 1.1 2007/06/25 07:24:49 srothkugel Exp $";
	 ...
	 */
	public InternalUnicastReceiveEvent(double time, DeviceID sender, LinkLayerMessage message, UnicastCallbackHandler handle,  InternalReceiveListener internalReceiveListener) {
		super(time);
		this.sender = sender;
    ...
    public void handle() {
		internalReceiveListener.notifyUnicastFinished(sender, message,handle);
	}
