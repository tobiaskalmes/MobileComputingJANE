/*****************************************************************************
 * 
 * ReceiveDeceider.java
 * 
 * $Id: ReceiveDecider.java,v 1.1 2007/06/25 07:23:46 srothkugel Exp $
 *  
 ...
 * TODO comment class
 */
public interface ReceiveDecider {
     ...
     * @return
     */
    boolean receive(InetAddress sender, byte[] data);
